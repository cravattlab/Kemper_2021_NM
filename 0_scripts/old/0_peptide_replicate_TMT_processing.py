...
def aggregate_stats(group_dataset, no_missed_sites, inputs):
    df = calculate_stats(group_dataset, no_missed_sites, inputs)
...
#for a dataset: perform functions defined above
    ...
    if a == 'all':
        for group_dataset in expt_table.index:
            ...
            df = aggregate_stats(group_dataset, no_missed_sites, inputs)
